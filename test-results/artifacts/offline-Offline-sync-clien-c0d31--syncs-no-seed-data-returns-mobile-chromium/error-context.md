...
- Name: offline.spec.ts >> Offline & sync (client) >> log offline → reload offline → data persists → reconnect syncs; no seed data returns
- Location: e2e\offline.spec.ts:58:3
