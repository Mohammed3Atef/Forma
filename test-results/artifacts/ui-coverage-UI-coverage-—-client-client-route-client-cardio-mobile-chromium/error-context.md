...
- Name: ui-coverage.spec.ts >> UI coverage — client >> client route: client-cardio
- Location: e2e\ui-coverage.spec.ts:74:5

# Error details

```
Error: client-cardio: page crashed / rendered empty
...
```
Error: client-cardio: bottom nav missing
