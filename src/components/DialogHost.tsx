...
export function DialogHost() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6" role="alertdialog" aria-modal="true" data-testid="confirm-dialog">
      ...
      <div ref={panelRef} tabIndex={-1} className="relative w-full max-w-sm rounded-xl2 bg-surface-card p-5 shadow-2xl focus:outline-none">
        ...
        <div className="mt-5 flex gap-2">
          {!isAlert && (
            <button type="button" data-testid="confirm-cancel" onClick={() => respond(false)} className="btn-ghost flex-1">
